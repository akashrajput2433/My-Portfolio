...
import { GitHubIcon, LiveDemoIcon } from '../components/SocialIcons'
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="space-y-3">
                    ...
                    <div className="project-impact-copy flex min-h-[8.5rem] items-center rounded-[24px] border border-brand-300/20 bg-brand-400/10 px-5 py-5 text-justify text-base leading-7 text-brand-50">
                    ...
                    <div className="flex flex-col gap-3 pt-1 min-[480px]:flex-row min-[480px]:flex-wrap">
                      ...
                      {activeProject.liveUrl ? (
                        <motion.a
                          className="secondary-button w-full gap-2 min-[480px]:w-auto"
